...
Single repository throughout (VeloRoute; researched on the `10x-architect-artifacts` branch at `c9eb8a0`, squash-merged to `main` as `e1b9b18`). All four artifacts below are grounded in that repo; no MISSING artifacts.
